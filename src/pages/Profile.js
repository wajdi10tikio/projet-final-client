...
import Classnames from 'classnames' /*bibliothéque react */
...
function Profile() {
  ...
  //ne5dhou les errors elli to5erjena bl useSelector
      ...
      <div className="row justify-content-evenly ">
        ...
        <div className="col-lg-6 col-md-12 ">
          <div className="d-flex">
            <i className="fa-solid fa-user fs-1 mx-2" style={{ color: "white" }}></i> <h2 style={{ color: "white" }}>Profile</h2>
          ...
          <div className="p-6 shadow-lg p-3 mb-5 bg-body rounded" style={{ backgroundColor: "white" }}>
            <form onSubmit={onSubmit}>
              ...
              <Inputs name="skills" label="Skills" type="text" value={form && form.skills ? form.skills : ""} onChangeHandler={onChangeHandler} errors={errors.bio} />
