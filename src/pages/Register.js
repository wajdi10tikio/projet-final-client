        ...
        <div className="col-lg-6 col-md-12 mt-4">
          ...
          <div className="p-6 shadow-lg p-3 mb-5 bg-body rounded" style={{ backgroundColor: 'white' }}>
            <form onSubmit={onSubmit}>
              ...
              <Inputs name="lastname" label="LastName" type="text" icon="fa-solid fa-user" onChangeHandler={onChangeHandler} errors={errors.lastname} />
              <Inputs name="firstname" label="FirstName" type="text" icon="fa-solid fa-user" onChangeHandler={onChangeHandler} errors={errors.firstname} />
